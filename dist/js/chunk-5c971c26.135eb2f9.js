    ...
    ["chunk-5c971c26"],
    {
        "552a": function(e, A, t) {
            ...
            var a = function() {
                    ...
                    return a(
                        ...
                        [
                            a(
                                ...
                                [
                                    a("headersec", { ref: "noback", attrs: { tabname: "我的订单" } }),
                                    a("ordertab", { attrs: { urlRouter: e.$route.path } }),
                                    a("transition", { attrs: { name: e.slidename } }, [
                                        a("div", { directives: [{ name: "show", rawName: "v-show", value: e.mainarea, expression: "mainarea" }], staticClass: "ordercontainer" }, [
                                            a("img", { attrs: { src: t("84a8"), alt: "" } }),
                                            a("p", [e._v("待收货页面")])
                                        ])
                                    ])
                                ],
                ...
                o = [],
                r = t("cebc"),
                s = (t("cadf"), t("551c"), t("f751"), t("097d"), t("2f62")),
                i = {
                    data: function() {
                        return {};
                    },
                    components: {
                        ...
                        Ordertab: function() {
                            return t.e("chunk-31cdc976").then(t.bind(null, "beaa"));
                        }
                    },
                    computed: Object(r["a"])({}, Object(s["b"])(["this.$store.state.ordercur"])),
                    mounted: function() {
                    ...
                    methods: Object(r["a"])(
                        ...
                        Object(s["c"])({ setOrdercur: "SET_ORDERCUR", setOrdertab: "SET_ORDERTAB" })
                    )
                },
                c = i,
                Q = t("2877"),
                B = Object(Q["a"])(c, a, o, !1, null, null, null);
            A["default"] = B.exports;
        },
        "84a8": function(e, A) {
            e.exports =
...
//# sourceMappingURL=chunk-5c971c26.135eb2f9.js.map
